...
const TrafficLightsIcon = (props: SVGProps<SVGSVGElement>) => (
        ...
        <div className="relative z-10 md:text-center lg:text-left">
          ...
          <div className="relative">
            ...
            <p className="mt-3 text-2xl tracking-tight text-slate-400">
              Velocity Core is a light-weight combination of tried-and-tested technologies for building high performance
              ...
              <div className="pl-4 pt-4">
                ...
                <div className="mt-4 flex space-x-2 text-xs">
                  {tabs.map(tab => (
                    ...
                    >
                      <div className={['flex items-center rounded-full px-2.5', tab.isActive && 'bg-slate-800']}>
                        {tab.name}
                      </div>
                    </div>
                  ))}
                ...
                <div className="mt-6 flex items-start px-1 text-sm">
                  ...
                  <pre className="flex overflow-x-auto pb-6">
                    <code className={['px-4 text-white', `language-${codeLanguage}`]}>
                      {unsafe(hljs.highlight(code, { language: codeLanguage }).value)}
                    </code>
                  </pre>
                </div>
              </div>
